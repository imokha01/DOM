...
form.addEventListener("submit", function(e){
    ...
    const R
    console.log(firstName.value, lastName.value, country.value, weekReportChecked.checked, pullRequestChecked.checked, deploymentChecked.checked, security.checked);
